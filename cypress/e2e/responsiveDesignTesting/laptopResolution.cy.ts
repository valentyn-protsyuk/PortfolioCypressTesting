...
describe("TESTING PORTFOLIO WEBSITE WITH WIDTH > 1025px && < 1280px", () => {
  beforeEach(() => {
    cy.visit("/");
  ...
  describe("TESTING PROFILE WITH LAPTOP RESOLUTION", () => {
    ...
    it("Verify profile img dimensions", () => {
      const remWidth = 8; //width in rem unit
      const remHeight = 11.5; //height in rem unit
      //check width
    ...
    it("Verify font size of main title", () => {
      cy.remToPx(seven_xl).then((pxFontSize) => {
