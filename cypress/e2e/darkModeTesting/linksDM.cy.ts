...
describe("LINKS SECTION TESTING in DARK MODE", () => {
  ...
  describe("MY LINKS MAIN TITLE TESTING", () => {
    it("Verify main title text", () => {
      cy.get(LinksPage.mainTitle)
        .invoke("text")
        .should("match", /my links/i);
    });
  ...
  describe("LINKEDIN BTN TESTS", () => {
    ...
    it("verify btn link", () => {
      //test navigation
      LinksPage.verifyLink(
        LinksPage.linkedinLink,
        "https://www.linkedin.com/in/valentyn-protsyuk/"
      );
    });
  });
  ...
  describe("EMAIL BTN TESTS", () => {
    ...
    it("verify btn link", () => {
      LinksPage.verifyLink(
        LinksPage.emailLink,
        "mailto:valentyn.protsyuk@yahoo.com"
      );
    });
  });
  ...
  describe("GITHUB BTN TESTS", () => {
    ...
    it("verify btn href", () => {
      LinksPage.verifyLink(
        LinksPage.githubLink,
        "https://github.com/valentyn-protsyuk"
      );
    });
  });
  ...
  describe("RESUME BTN TESTS", () => {
    ...
    it("verify btn href", () => {
      LinksPage.verifyLink(
        LinksPage.resumeLink,
        "https://docs.google.com/document/d/1RPsT-rBYSbn3MPvw1z5EogvEGY6PXEydN-taSgRib0o/edit?usp=sharing"
      );
    });
  });
});
